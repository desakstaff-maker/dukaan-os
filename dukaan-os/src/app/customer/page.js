...
import { Award, Calendar, MessageSquare, LogOut, Phone, User, CheckCircle, ArrowRight } from 'lucide-react';
          ...
          <div className="bg-white border-2 border-black rounded-lg p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            ...
            {!otpSent ? (
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-4">
                <div>
                  <label className="block text-[10px] font-black tracking-wider uppercase text-slate-600 mb-1">Enter 4-Digit OTP Code</label>
                  <input
                    type="text"
                    ...
                    required
                  />
                  <p className="text-[10px] text-slate-500 mt-1.5 font-bold text-center">Simulated OTP verification. Enter any 4-digit code to proceed.</p>
                </div>
