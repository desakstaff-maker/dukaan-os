          ...
          currentUser &&
            ...
            ? (
              ...
              <div>
                ...
                <div className="bg-primary text-white border-2 border-black rounded-lg p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-5">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-[10px] font-black tracking-wider uppercase border border-white/55 px-2 py-1 rounded"
                    >
                  ...
                  <button
                    ...
                    className="w-full text-left bg-white text-black border-2 border-black rounded-md p-3 mt-4 flex justify-between items-center"
                  >
                ...
                <h3 className="text-xs font-black tracking-wider text-slate-500 uppercase mb-2">
                  📊 Booking Statistics
                </h3>
                        ...
                        filteredReservations
                          .map(
                            res => {
                              ...
                              const waMsg =
                                `Hi, I am visiting your store. My reservation Ticket ID is: ${res.id}`;

                              const waUrl =
                                `https://wa.me/${res.shopPhone ||
                                '919999999999'
                              ...
                              return (
                                ...
                                <div
                                  key={res.id}
                                  className="bg-white border-2 border-black rounded-lg p-3.5 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
                                >
                                  ...
                                  <div className="flex justify-between items-center border-b border-slate-100 pb-2 mb-2">
                                    ...
                                    <span
                                      className={`px-2.5 py-0.5 rounded border text-[10px] font-black ${style.bg} ${style.border} ${style.color}`}
                                    >
                                      {style.text}
                                    </span>
                                    ...
                                    res.status === 'visited') && (
                                      ...
                                      <div className="grid grid-cols-2 gap-2 text-xs">
                                        ...
                                        <Link
                                          ...
                                          className="flex items-center justify-center gap-1 py-1.5 bg-primary text-white border-2 border-black rounded font-black"
                                        >
              ...
              <div className="bg-white border-2 border-black rounded-lg p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="text-xs text-slate-500 text-center mb-5">
                  Provide details to register your mobile wallet permanently.
                </p>
                ...
                >
                  ...
                  <div>
                    ...
                    <label className="block text-[10px] font-black tracking-wider uppercase text-slate-600 mb-1">
                      Full Name
                    </label>
                  ...
                  <button
                    type="submit"
                    className="w-full py-2.5 bg-primary text-white border-2 border-black rounded-md font-black"
                  >
                    Create My Account
                  </button>
              ...
              <div className="bg-white border-2 border-black rounded-lg p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="text-xs text-slate-500 text-center mb-5">
                  Enter phone number to receive a verification OTP code.
                </p>
                  ...
                  >
                    ...
                    <div>
                      ...
                      {!isLiveFirebase && (
                        ...
                        <p className="text-[10px] text-slate-500 mt-1.5 font-bold text-center">
                ...
                <div className="mt-6 border-t border-slate-200 pt-5 text-center">
                  ...
                  <p className="text-[10px] font-black text-slate-400 tracking-wider uppercase mb-2">
                    Simulated Accounts
                  </p>
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-white text-slate-800 border-2 border-black rounded-md font-extrabold text-xs flex items-center justify-center gap-1.5"
                  >
